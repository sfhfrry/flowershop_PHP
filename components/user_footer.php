<div class="newsletter">  
    <div class="box-detail">  
        ...
        <p>Điều quan trọng nhất là luôn chăm sóc khách hàng tận tâm, đảm bảo chất lượng sản phẩm và tuân thủ mọi quy trình phục vụ. Chúng tôi cam kết mang đến những đóa hoa tươi thắm nhất, như cách bạn gửi gắm tình yêu và sự quan tâm đến người nhận.</p>  
        <div action="subscribr.php" method="POST" class="input-field">  
            <input type="email" name="email" placeholder="Your email..." class="box"><br>  
            <a href="subscribe.php" class="btn">Đăng kí</a>
        </div>  
        <div>
...
<div class="heading">  
    ...
    <div class="client">
        <div class="img-box">
            <img src="image/client.jpg" alt="Client 1">
        </div>
        <div class="img-box">
            <img src="image/client0.jpg" alt="Client 2">
        </div>
        <div class="img-box">
            <img src="image/client1.jpg" alt="Client 3">
        </div>
        <div class="img-box">
            <img src="image/client2.jpg" alt="Client 4">
        </div>
        <div class="img-box">
            <img src="image/client1.jpg" alt="Client 5">
        </div>  
    </div>
</div>
